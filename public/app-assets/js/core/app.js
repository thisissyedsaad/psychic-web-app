...
(function (window, document, $) {
  ...
  function checkMode(){
      if (typeof(Storage) !== "undefined") {
          ...
          if(mode == current){ //checking for default mode
              changeMode();
          }
      }
  }
  ...
  function changeMode(){
      ...
      if (typeof(Storage) !== "undefined") {
          // Store
          sessionStorage.setItem("mode", currentLayout);
      ...
      if (switchToLayout === 'dark-layout') {
          ...
          $('.ficon').replaceWith(feather.icons['sun'].toSvg({ class: 'ficon' }));
      } else {
          $body.addClass(prevLayout);
          mainMenu.removeClass('menu-dark').addClass('menu-light');
          navbar.removeClass('navbar-dark').addClass('navbar-light');
          $('.ficon').replaceWith(feather.icons['moon'].toSvg({ class: 'ficon' }));
      }
