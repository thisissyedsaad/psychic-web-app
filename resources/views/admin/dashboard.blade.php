                                    ...
                                    <div class="row">
                                        <div class="col-xl-3 col-sm-6 col-12 mb-2 mb-xl-0">
                                            <div class="media">
                                                ...
                                                <div class="media-body my-auto">
                                                    ...
                                                    <p class="card-text font-small-3 mb-0">Total Psychics</p>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-xl-3 col-sm-6 col-12 mb-2 mb-xl-0">
                                            <div class="media">
                                                ...
                                                <div class="media-body my-auto">
                                                    <h4 class="font-weight-bolder mb-0">0</h4>
                                                    <p class="card-text font-small-3 mb-0">Active Services</p>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-xl-3 col-sm-6 col-12">
                                            <div class="media">
                                                ...
                                                <div class="media-body my-auto">
                                                    <h4 class="font-weight-bolder mb-0">0</h4>
                                                    <p class="card-text font-small-3 mb-0">Average Rating</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
