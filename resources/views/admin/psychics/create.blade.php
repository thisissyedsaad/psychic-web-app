    ...
    <div class="app-content content">
        ...
        <div class="content-wrapper">
            <div class="content-header row">
                <div class="content-header-left col-md-9 col-12 mb-2">
                    <div class="row breadcrumbs-top">
                        <div class="col-12">
                            <h2 class="content-header-title float-left mb-0">Add New Psychic</h2>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="content-body">
                <div class="card">
                    <div class="card-body">
                        <form id="psychicForm" action="{{ route('psychics.store') }}" method="POST"
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control @error('website_title') is-invalid @enderror"
                                            id="website_title" name="website_title" value="{{ old('website_title') }}"
                                            ...
                                            @foreach($psychicServices as $service)
                                                <div class="form-check mb-1">
                                                    <input class="form-check-input" type="checkbox" name="services[]"
                                                        value="{{ $service->id }}" id="service_{{ $service->id }}" {{ (is_array(old('services')) && in_array($service->id, old('services'))) ? 'checked' : '' }}>
                            ...
                            <div class="row mt-2">
                                <div class="col-md-4">
                                    <button type="button" class="btn btn-outline-primary btn-block" data-toggle="modal"
                                        data-target="#appLinksModal">
                                        <i data-feather="link"></i> Add App Links
                                    </button>
                                </div>
                                <div class="col-md-4">
                                    <button type="button" class="btn btn-outline-primary btn-block" data-toggle="modal"
                                        data-target="#paymentLinksModal">
                                        <i data-feather="credit-card"></i> Add Payment Links
                                    </button>
                                </div>
                                <div class="col-md-4">
                                    <button type="button" class="btn btn-outline-primary btn-block" data-toggle="modal"
                                        data-target="#socialLinksModal">
                            ...
                            <!-- App Links Modal -->
                            <div class="modal fade" id="appLinksModal" tabindex="-1" role="dialog"
                                aria-labelledby="appLinksModalLabel" aria-hidden="true">
                                                ...
                                                @forelse($appLinks as $appLink)
                                                    <div class="app-link-item mb-3">
                                                        <div class="d-flex align-items-center mb-1">
                                                            @if($appLink->logo)
                                                                <img src="{{ Storage::url($appLink->logo) }}"
                                                                    alt="{{ $appLink->app_name }}" class="mr-2"
                                                                    style="width: 24px;">
                                                            @else
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                <input type="text" class="form-control"
                                                                    value="{{ $appLink->url_prefix }}" readonly>
                                                            </div>
                                                            <div class="col-md-6">
                                                                <input type="text" class="form-control"
                                                                    name="app_links[{{ strtolower(str_replace(' ', '_', $appLink->app_name)) }}]"
                                                                    value="{{ old('app_links.' . strtolower(str_replace(' ', '_', $appLink->app_name))) }}"
                            ...
                            <!-- Payment Links Modal -->
                            <div class="modal fade" id="paymentLinksModal" tabindex="-1" role="dialog"
                                aria-labelledby="paymentLinksModalLabel" aria-hidden="true">
                                <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                        ...
                                        <div class="modal-body">
                                            <div class="payment-links-container">
                                                @forelse($paymentLinks as $paymentLink)
                                                    <div class="payment-link-item mb-3">
                                                        <div class="d-flex align-items-center mb-1">
                                                            @if($paymentLink->logo)
                                                                <img src="{{ Storage::url($paymentLink->logo) }}"
                                                                    alt="{{ $paymentLink->payment_provider }}" class="mr-2"
                                                                    style="width: 24px;">
                                                            @else
                                                                <span class="text-muted mr-2">No logo</span>
                                                            @endif
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                <input type="text" class="form-control"
                                                                    value="{{ $paymentLink->url_prefix }}" readonly>
                                                            </div>
                                                            <div class="col-md-6">
                                                                <input type="text" class="form-control"
                                                                    name="payment_links[{{ strtolower(str_replace(' ', '_', $paymentLink->payment_provider)) }}]"
                                                                    value="{{ old('payment_links.' . strtolower(str_replace(' ', '_', $paymentLink->payment_provider))) }}"
                                                        ...
                                                        <div class="mt-2">
                                                            ...
                                                            <div class="custom-file">
                                                                <input type="file" class="custom-file-input"
                                                                    name="payment_qr[{{ strtolower(str_replace(' ', '_', $paymentLink->payment_provider)) }}]"
                                                                    accept="image/*">
                                                                <label class="custom-file-label">Upload QR Code</label>
                                                            </div>
                                                        </div>
                                                    </div>
                                                @empty
                            ...
                            <!-- Social Links Modal -->
                            <div class="modal fade" id="socialLinksModal" tabindex="-1" role="dialog"
                                aria-labelledby="socialLinksModalLabel" aria-hidden="true">
                                <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            ...
                                            <div class="social-links-container">
                                                @forelse($socialMediaLinks as $socialLink)
                                                    <div class="social-link-item mb-3">
                                                        <div class="d-flex align-items-center mb-1">
                                                            @if($socialLink->logo)
                                                                <img src="{{ Storage::url($socialLink->logo) }}"
                                                                    alt="{{ $socialLink->social_site }}" class="mr-2"
                                                                    style="width: 24px;">
                                                            @else
                                                                <span class="text-muted mr-2">No logo</span>
                                                            @endif
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                <input type="text" class="form-control"
                                                                    value="{{ $socialLink->url_prefix }}" readonly>
                                                            </div>
                                                            <div class="col-md-6">
                                                                <input type="text" class="form-control"
                                                                    name="social_links[{{ strtolower(str_replace(' ', '_', $socialLink->social_site)) }}]"
                                                                    value="{{ old('social_links.' . strtolower(str_replace(' ', '_', $socialLink->social_site))) }}"
...
@section('scripts')
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            if (hasAppLinkValues && !modalToShow) {
                modalToShow = '#appLinksModal';
            }
            ...
            if (hasPaymentLinkValues && !modalToShow) {
                modalToShow = '#paymentLinksModal';
            }
            ...
            if (hasSocialLinkValues && !modalToShow) {
                modalToShow = '#socialLinksModal';
            }

            // Show the first modal that has data
            if (modalToShow) {
