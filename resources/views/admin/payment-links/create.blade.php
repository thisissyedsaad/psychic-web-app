            ...
            <div class="content-header row">
                <div class="content-header-left col-md-9 col-12 mb-2">
                    <div class="row breadcrumbs-top">
                        <div class="col-12">
                            <h2 class="content-header-title float-left mb-0">Add New Payment Link</h2>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="card-body">
                        <form action="{{ route('payment-links.store') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @error('payment_provider') is-invalid @enderror"
                                    id="payment_provider" name="payment_provider" value="{{ old('payment_provider') }}">
