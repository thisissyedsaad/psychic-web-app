...
<div class="app-content content">
    ...
    <div class="content-wrapper">
        <div class="content-header row">
            <div class="content-header-left col-md-9 col-12 mb-2">
                <div class="row breadcrumbs-top">
                    <div class="col-12">
                        <h2 class="content-header-title float-left mb-0">Edit Social Media Link</h2>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="content-body">
            <div class="card">
                <div class="card-body">
                    <form action="{{ route('social-media-links.update', $socialMediaLink) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" 
                                   class="form-control @error('social_site') is-invalid @enderror" 
                                   id="social_site" 
                                   name="social_site" 
                                   value="{{ old('social_site', $socialMediaLink->social_site) }}" >
                            @error('social_site')
                        ...
                        <div class="form-group">
                            ...
                            <input type="url" 
                                   ...
                                   id="url_prefix" 
                                   name="url_prefix" 
                                   value="{{ old('url_prefix', $socialMediaLink->url_prefix) }}" >
                            @error('url_prefix')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
