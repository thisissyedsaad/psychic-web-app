...
@section('title', $page && $page->meta_title ? $page->meta_title : ($page ? $page->title : 'Terms and Conditions'))
@section('meta_title', $page && $page->meta_title ? $page->meta_title : ($page ? $page->title : 'Terms and Conditions'))
@section('meta_description', $page && $page->meta_description ? $page->meta_description : ($page ? Str::limit(strip_tags($page->content), 160) : 'Terms and Conditions for Top Rated Psychics'))
@section('meta_tags')
